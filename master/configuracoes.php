	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-info">
					...
					<label class="section-title"><i class="fa fa-check-square-o" aria-hidden="true"></i> DADOS DA EMPRESA</label>
					<hr>
					...
					<div class="row">
                        ...
                        <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="enderecom" value="<?php print $dadoscat->enderecom; ?>" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>CONTATO</label>
								<input type="text" class="form-control" name="contato" value="<?php print $dadoscat->contato; ?>" required>
							</div>
						</div>
			...
			<div class="col-md-12">
				<div class="card card-info">
					...
					<div class="row">
						...
						<code>curl https://seusite.com.br/crons/cob_auto.php >/dev/null 2>&1 </code><br/><br/>
						<code>curl https://seusite.com.br/crons/conf_pgmto.php >/dev/null 2>&1 </code><br/><br/>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-info">
					<div class="card-body" align="justify">
					<label class="section-title"><i class="fa fa-check-square-o" aria-hidden="true"></i> API INTEGRADA NO SISTEMA</label>
					<hr>
					
					<div class="row">
						<div class="col-md-12">
						- Atualmente você está sem API, caso queira uma adquira um VPS:<br/><br/>
						
						1 - Contrate uma VPS básica <a href="https://contabo.com/en/vps/" target="_blank">Clique aqui...</a> Se possuir uma basta formatar e colocar ubunto 20.4<br/><br/>
						
						2 - Crie um subdimonio do (tipo A) apontando pro IP da sua VPS:<br/><br/>
						
						3 - Nos fazemos a instalação pra você por valor de R$ 50,00 Basta contrata uma Vps.<br/><br/> PLW Design<br/>
